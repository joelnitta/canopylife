...
ggsave(plot = fig_s1, filename = here::here("ms/Fig_S1.pdf"), height = 8, width = 4, units = "in")
```
...
ggsave(plot = cwsd_scatterplot, filename = here::here("ms/Fig_S2.pdf"), height = 6, width = 7, units = "in")
```
