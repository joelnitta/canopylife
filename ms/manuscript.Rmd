...
climate_plot
ggsave(plot = climate_plot, filename = here("ms/fig1.pdf"), height = 4, width = 6, units = "in")
```
...
pca_plot
ggsave(plot = pca_plot, filename = here("ms/fig2.pdf"), height = 6, width = 6, units = "in")
```
...
traits_with_tree
ggsave(plot = traits_with_tree, filename = here("ms/fig3.pdf"), height = 8, width = 6, units = "in")
```
...
importance_heatmap
ggsave(plot = importance_heatmap, filename = here("ms/fig4.pdf"), height = 4, width = 6, units = "in")
```
...
combined_cwm_plots
ggsave(plot = combined_cwm_plots, filename = here("ms/fig5.pdf"), height = 4, width = 8, units = "in")
```
...
ggsave(plot = combined_comm_div_plots, filename = here("ms/fig6.pdf"), height = 8, width = 4, units = "in")
```
