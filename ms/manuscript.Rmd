...
climate_plot
ggsave(plot = climate_plot, filename = here::here("ms/fig1.tiff"), height = 4, width = 6, units = "in", dpi = "retina")
```
...
pca_plot
ggsave(plot = pca_plot, filename = here::here("ms/fig2.tiff"), height = 6, width = 6, units = "in", dpi = "retina")
```
...
traits_with_tree
ggsave(plot = traits_with_tree, filename = here::here("ms/fig3.tiff"), height = 8, width = 6, units = "in", dpi = "retina")
```
...
importance_heatmap
ggsave(plot = importance_heatmap, filename = here::here("ms/fig4.tiff"), height = 4, width = 6, units = "in", dpi = "retina")
```
...
combined_cwm_plots
ggsave(plot = combined_cwm_plots, filename = here::here("ms/fig5.tiff"), height = 4, width = 8, units = "in", dpi = "retina")
```
...
ggsave(plot = combined_comm_div_plots, filename = here::here("ms/fig6.tiff"), height = 8, width = 4, units = "in", dpi = "retina")
```
